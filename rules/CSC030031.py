...
def CheckCSC030031(filename, file_extension, clean_lines, rawlines, nesting_state, ruleCheckKey, Error, cpplines, fileErrorCount):
  '''右括号 ) 之前不要留空格
  Args:
    filename:文件名
  ...
  errMessage = 'Code Style Rule: There should be no space before a right parenthesis. For example: Function(x, y, z).'
